...
<div className="sidebar py-[50px] w-[276px] px-[12px] bg-[#0F0F0F]">
            <button className="bg-[#1E34F9] rounded-[8px] pl-[32px] text-left w-[100%] h-[52px] font-['Mona-Sans-S'] text-[#ddd] text-[14px]">
              Browse
            </button>
            ...
            <div className="py-[16px] font-['Mona-Sans-M'] flex px-[24px]">
              <svg
