...
const InboxTab: React.FC<InboxTabProps> = ({ tabName, icon, currentTab, tabValue, onClick, unreadMessageCount, color }) => {
  const isActive = currentTab === tabValue;
  
  return (
    <div className={`bg-[#08090a] cursor-pointer h-[59px] w-[200px] flex items-center justify-center ${
      isActive 
