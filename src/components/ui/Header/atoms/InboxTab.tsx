...
const InboxTab: React.FC<InboxTabProps> = ({ tabName, icon, currentTabIndex, onClick, tabIndex, unreadMessageCount, color }) => {
  return (
    ...
    onClick={onClick}>
      ...
      <span>{tabName}</span>
      <MessageCountBubble unreadMessages={unreadMessageCount} color={color} isSelected={true}></MessageCountBubble>
    </div>
  );
};
