...
const CollaborationRequestNotifContent = ({ notification }: { 
  ...
  const [status, setStatus] = useState(notification.collaborationRequest.status);
        ...
        {status === "PENDING" && (
          <>
            <NotificationButton
              ...
              onClick={() => { handleAccept(); handleCollaborationRequest(notification.sample.id, true); }}
              icon={null}
            />
            <NotificationButton
              buttonName="Deny"
              ...
              onClick={() => { handleDeny(); handleCollaborationRequest(notification.sample.id, false); }}
              icon={null}
            />
          </>
        )}
