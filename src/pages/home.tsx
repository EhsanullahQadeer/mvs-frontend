...
const HomeFeed = () => {
  ...
  return (
    <React.Fragment>
      <Theme>
        <div className="flex flex-col min-h-screen w-full bg-[#101010] h-full">
          
          <div className="bg-[#151515] p-[40px]">
            <p className="text-[#B9B9B9] text-[32px] font-['Mona-Sans-S']">
              Browse
            </p>
            <div className="mt-[16px] flex font-['Mona-Sans-M']">
              <button
                onClick={() => {
                  setSample(true);
                  setVocal(true);
                ...
                className={`${
                  sample === true
                    ? "border mr-[12px] bg-[#C4FF4826] px-[16px] py-[12px] border-[#C4FF48] border-2px text-[#fff] rounded-[100px]"
                    : "border mr-[12px] px-[16px] py-[12px] border-[#5C5C5C] border-2px text-[#5C5C5C] rounded-[100px]"
                }`}
              >
                Sample Loops
              </button>
