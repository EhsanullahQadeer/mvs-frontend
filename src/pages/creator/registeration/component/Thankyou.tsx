    ...
    <>
      ...
      <div className="flex text-center gap-5 flex-col justify-center items-center w-1/2">
        ...
        <p className="text-[#b2b2b2]">
          Your application has been received and is currently under review. You
          will receive an email notification once your account has been approved
          and is ready for use. if you have any questions or need assistance,
          please contact our{" "}
