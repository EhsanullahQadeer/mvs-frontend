...
const Sidebar = ({ isPlayerVisible }: { isPlayerVisible: boolean }) => {
  const navigate = useNavigate();
  const { pathname } = useLocation();
  const [notificationsVisible, setNotificationsVisible] = useState(false);

  const toggleViewNotifications = () => {
    setNotificationsVisible(!notificationsVisible); // Toggle the slide-out window
  };

  const closeNotifications = () => {
    setNotificationsVisible(false); // Close the slide-out window
  };
  ...
  return (
    <React.Fragment>
      <div className="relative z-[999]">
        <div className="sidebar fixed py-[12px] w-[88px] h-full px-[12px] bg-[#08090A] overflow-y-auto pb-[60px]">
          {/* Main Sidebar Icons */}
          <div className="flex-grow">
            {/* Lines button/ Hamburger Menu */}
            <button
              onClick={() => {
                // @TODO check what this button does
                navigate("/home");
              }}
              className="cursor-pointer w-[100%] h-[76px] flex flex-col items-center justify-center z-[3000]"
            >
            ...
            >
              ...
              >
                ...
                >
                  <path
                    d="M7 21.5V11.5H13V21.5M1 8.5L10 1.5L19 8.5V19.5C19 20.0304 18.7893 20.5391 18.4142 20.9142C18.0391 21.2893 17.5304 21.5 17 21.5H3C2.46957 21.5 1.96086 21.2893 1.58579 20.9142C1.21071 20.5391 1 20.0304 1 19.5V8.5Z"
                    stroke="currentColor"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
              ...
              <span
                className={`pt-[4px] text-[12px] font-["Mona-Sans-S"] text-[#FFFFFF]`}
              >
                Home
              </span>
            </button>
            ...
            >
              ...
              >
                ...
                >
                  <path
                    d="M7 17.5V7.5M13 17.5V1.5M1 17.5V13.5"
                    stroke="currentColor"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
            ...
            >
              ...
              >
                ...
                >
                  <path
                    d="M15.5 7.50024C15.7761 7.50024 16 7.27639 16 7.00024C16 6.7241 15.7761 6.50024 15.5 6.50024C15.2239 6.50024 15 6.7241 15 7.00024C15 7.27639 15.2239 7.50024 15.5 7.50024Z"
                    fill="black"
                  />
                  <path
                    d="M1 17.5002V20.5002C1 21.1002 1.4 21.5002 2 21.5002H6V18.5002H9V15.5002H11L12.4 14.1002C13.7898 14.5843 15.3028 14.5825 16.6915 14.0949C18.0801 13.6074 19.2622 12.663 20.0444 11.4163C20.8265 10.1696 21.1624 8.69433 20.9971 7.2319C20.8318 5.76946 20.1751 4.40641 19.1344 3.36573C18.0938 2.32505 16.7307 1.66834 15.2683 1.50305C13.8058 1.33776 12.3306 1.67366 11.0839 2.4558C9.83716 3.23795 8.89279 4.42003 8.40525 5.80868C7.91771 7.19733 7.91586 8.71033 8.4 10.1002L1 17.5002Z"
                    stroke="currentColor"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
            ...
            <div className="onboard-2">
              ...
              ${
                ...
                >
                  ...
                  >
                    <path
                      d="M1 8.5V11.5M5 4.5V15.5M9 1.5V19.5M13 6.5V13.5M17 3.5V16.5M21 8.5V11.5"
                      stroke="currentColor"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
        ...
        <div
          className={`fixed bottom-0 left-0 w-[90px] flex flex-col items-center justify-center pt-1 bg-[#08090A] border-r-2 border-[#1F1F1F] gap-6
        ${isPlayerVisible ? "pb-[82px]" : "pb-4"}`}
        >
          <button
            className="relative w-[40px] h-[40px] rounded-full flex items-center justify-center "
            onClick={toggleViewNotifications}
          >
            <div className="text-[#FFF] bg-[#08090A] hover:bg-[#1C1C1C] w-full h-full rounded-full flex items-center justify-center">
              <svg
                width="20"
                height="23"
                viewBox="0 0 20 23"
      ...
      {notificationsVisible && (
        <div
          ...
          onClick={closeNotifications} // Close the slide-out if the backdrop is clicked
        />
      )}
    </React.Fragment>
  );
